...
if __name__ == '__main__':
    ...
    if outcome:
        if args.latex:
            display_invariant_latex(outcome)
        elif args.out_inv:
            display_invariant(outcome, extra)
    ...
    # Write results to shelve
    if args.filename is not None:
        store_stats("benchmarks.shelf", args, status, outcome, watch, pdr)
